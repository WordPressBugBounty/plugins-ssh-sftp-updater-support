...
== Upgrade Notice ==
* 1.1.1: Resolve PHP notice. N.B. If you are currently on 0.8.7 and cannot update through the dashboard, then you can download the plugin manually from https://downloads.wordpress.org/plugin/ssh-sftp-updater-support.1.1.1.zip and upload it in your WP dashboard in "Plugins -> Add New -> Upload Zip".
